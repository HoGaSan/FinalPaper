...
setwd("/app/finalProject/wildLife")
#getwd()
...
sr_1990_1999 <- data.table(read.csv("/app/finalProject/wildLife/STRIKE_REPORTS (1990-1999).csv", header = FALSE))
sr_2000_2009 <- data.table(read.csv("/app/finalProject/wildLife/STRIKE_REPORTS (2000-2009).csv", header = FALSE))
sr_2010_Current <- data.table(read.csv("/app/finalProject/wildLife/STRIKE_REPORTS (2010-Current).csv", header = FALSE))
srb_1990_Current <- data.table(read.csv("/app/finalProject/wildLife/STRIKE_REPORTS_BASH (1990-Current).csv", header = FALSE))
