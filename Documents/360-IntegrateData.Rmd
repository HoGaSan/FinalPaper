...
The model creation should take into account those airports for which the United States Department of Transportation have flight data provided, meaning that only those airports should be used which have a matching record as the origin or the destination destination airport in the flight data.
