...
The data set provided by the Federal Aviation Administration is a data set created based on the Airport Master Record (5010-*) forms. The following list of issue(s) needs to be corrected in a later stage of the project:
